...
public class ImmutableASTTransformation extends AbstractASTTransformation {
    ...
    private static final Class MY_CLASS = ImmutableClass.class;
...
//        createConstructors(this, cNode, knownImmutableClasses, knownImmutables, includeSuperProperties);
    ...
    private static void createConstructors(AbstractASTTransformation xform, ClassNode cNode, List<String> knownImmutableClasses, List<String> knownImmutables, boolean includeSuperProperties) {
    ...
    static void createConstructorMap(AbstractASTTransformation xform, ClassNode cNode, List<PropertyNode> list, List<String> knownImmutableClasses, List<String> knownImmutables) {
        final BlockStatement body = new BlockStatement();
    ...
    public static Object checkImmutable(Class<?> clazz, String fieldName, Object field) {
        ImmutableClass immutable = (ImmutableClass) clazz.getAnnotation(MY_CLASS);
