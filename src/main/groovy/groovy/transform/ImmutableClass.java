 ...
 * Checks on the validity of an immutable class and also acts as a marker interface for
 * other annotations which produce different results when an immutable class is required.
 * Usually used via the {@code @Immutable} meta annotation.
 *
 * @see groovy.transform.Immutable
 * @see groovy.transform.MapConstructor
